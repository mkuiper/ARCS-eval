...
- tabbed TUI/operator dashboard (`arcs-tui`) with scenario show/phases/new/add-phase/set-phase/set-completion/add-rubric/preview-yaml commands plus help/examples tabs, selectable scenario rows, and an in-TUI selected-scenario metadata editor slice
...
6. TUI operator dashboard — tabbed navigation, scenario authoring commands, preview-yaml, selectable scenario rows, metadata editor slice, and story-phase preview/update commands implemented; full-screen editor forms and launcher panes next
